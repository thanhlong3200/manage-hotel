...
<form id="formSubmit" action="<c:url value = "/quan-tri/booking"/>">
	<div class="search-form-booking">
	  ...
	  <c:if test="${not empty bookingCode}">
			<a style="height:45px;font-weight:600;line-height:45px;" href="<c:url value ="/quan-tri/booking?page=1&limit=2"/>" class="btn btn-light">
			    Trở về
			 </a>
		</c:if>
